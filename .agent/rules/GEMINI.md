...
# GEMINI.md - F2C Framework

> This file defines how the AI behaves in the F2C workspace.
...
- Agents: `.agent/agents/` (20 agents: 5 FMCG + 15 core)
- Skills: `.agent/skills/` (64 skills: 12 FMCG + 52 core)
- Workflows: `.agent/workflows/` (21 workflows: 6 FMCG + 15 core)
- Brands: `.agent/brands/fmcg-food/`
- Industry knowledge: `.agent/brands/fmcg-food/_common/industry.md`
- Docs: `.agent/docs/`
...
|---|---|---|---|
| **FMCG Brand Strategy** | `fmcg-brand-strategist` | shared | d2c-brand-building, fmcg-market-intelligence |
| **FMCG Operations** | `fmcg-operations-manager` | shared | fmcg-product-development, d2c-packaging-design |
| **FMCG Growth** | `d2c-growth-hacker` | marketing | d2c-influencer-marketing, paid-ads |
| **FMCG Finance** | `fmcg-finance-advisor` | shared | fmcg-funding-pitch, fmcg-legal-compliance |
| **FMCG Content** | `fmcg-content-creator` | marketing | d2c-content-strategy, social-content |
| **WEB** (D2C site) | `frontend-specialist` | shared | frontend-design, nextjs-react-expert |
| **BACKEND** (API, DB) | `backend-specialist` | dev | api-patterns, database-design |
| **MARKETING** (Copy, SEO, Ads) | (skill-based) | marketing | copywriting, seo-audit |
...
| FMCG Brand | `.agent/agents/fmcg-brand-strategist.md` |
| FMCG Ops | `.agent/agents/fmcg-operations-manager.md` |
| FMCG Content | `.agent/agents/fmcg-content-creator.md` |
...
| `ARCHITECTURE.md` | System map — 20 agents, 64 skills, 21 workflows |
| `profiles/*.md` | Project-type routing — dev, marketing, hybrid |
| `brands/fmcg-food/mom-ka-nuska/context.md` | Brand identity — profile, voice, audience |
...
- **FMCG**: `fmcg-brand-strategist`, `d2c-growth-hacker`, `fmcg-operations-manager`, `fmcg-finance-advisor`, `fmcg-content-creator`
